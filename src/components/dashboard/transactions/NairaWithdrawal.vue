    ...
    <div id="">
      <div class="">
        ...
        <div class="note d-flex" style="gap: 8px">
          ...
          <div>
            <p>Minimum Withdrawl: 5,000NGN</p>
        ...
        <div class="d-flex flex-column mt-2" style="gap: 15px">
          ...
          <div>
            ...
            <select v-model="bankName" id="mySelect" class="tw-p-3" @change="getBankCode">
          ...
          <div>
            ...
            <div class="wallet-balance">
              <span
                >Account Balance:
                <span class="balance">{{ NGNActualBalance }}</span>NGN</span
              >
            </div>
          </div>
        ...
        <div class="text-center mt-4">
          <button class="button primary-btn w-50 py-3" @click="requestFundsWithdrawal">Continue</button>
        </div>
      </div>
    </div>
  </template>
