  ...
  <div class="auth-content">
    <div>
      <div class="tw-mb-8">
        ...
        <h5 class="tw-font-bold tw-text-2xl tw-mb-0">How'dy!</h5>
        <small class="tw-text-light tw-text-xs"
          >Enter your details to create a new Pi2P account and start trading.</small
        >
      </div>
      ...
      <div class="tw-text-center tw-mt-3">
        <span class="tw-text-sm tw-font-semibold"
          ...
          <router-link to="/login" class="tw-text-primary500"
            >Login</router-link
          >
        </span>
      </div>
